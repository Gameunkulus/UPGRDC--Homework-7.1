// HomeworkUPGRD-7.1.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
public:
    ...
    {
        unique_ptr <tridiagonal_matrix> clone = make_unique<tridiagonal_matrix>(m_down, m_upper, m_middle);
            return clone;
    };
